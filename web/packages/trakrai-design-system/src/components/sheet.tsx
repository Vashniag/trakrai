...
const SheetContent = ({
  ...
  showCloseButton?: boolean;
      ...
      >
        {children}
        {showCloseButton ? <SheetPrimitive.Close asChild data-slot="sheet-close">
...
const SheetTitle = ({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Title>) => <SheetPrimitive.Title
