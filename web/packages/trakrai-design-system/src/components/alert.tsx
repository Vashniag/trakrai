...
const AlertTitle = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
...
const AlertDescription = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
...
const AlertAction = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
