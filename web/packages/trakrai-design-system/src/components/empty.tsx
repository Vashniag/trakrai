...
const Empty = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
...
const EmptyHeader = ({ className, ...props }: React.ComponentProps<'div'>) => <div
...
const EmptyMedia = ({
  ...
  variant = 'default',
  ...props
}: React.ComponentProps<'div'> & VariantProps<typeof emptyMediaVariants>) => <div
...
const EmptyTitle = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn('font-heading text-sm font-medium', className)}
      data-slot="empty-title"
      {...props}
    />;

const EmptyDescription = ({ className, ...props }: React.ComponentProps<'p'>) => <div
      className={cn(
...
const EmptyContent = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
