...
const NavigationMenuList = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.List>) => <NavigationMenuPrimitive.List
...
const NavigationMenuItem = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Item>) => <NavigationMenuPrimitive.Item
...
const NavigationMenuContent = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Content>) => <NavigationMenuPrimitive.Content
      className={cn(
...
const NavigationMenuViewport = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Viewport>) => <div className={cn('absolute top-full left-0 isolate z-50 flex justify-center')}>
...
const NavigationMenuLink = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) => <NavigationMenuPrimitive.Link
      className={cn(
...
const NavigationMenuIndicator = ({
  className,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Indicator>) => <NavigationMenuPrimitive.Indicator
      className={cn(
