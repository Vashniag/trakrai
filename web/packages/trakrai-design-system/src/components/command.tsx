...
import { InputGroup, InputGroupAddon } from '@trakrai/design-system/components/input-group';
import { cn } from '@trakrai/design-system/lib/utils';
import { Command as CommandPrimitive } from 'cmdk';
import { SearchIcon, CheckIcon } from 'lucide-react';

const Command = ({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) => <CommandPrimitive
      className={cn(
...
const CommandInput = ({
  className,
  ...props
}: React.ComponentProps<typeof CommandPrimitive.Input>) => <div className="border-b pb-0" data-slot="command-input-wrapper">
...
const CommandList = ({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) => <CommandPrimitive.List
      className={cn(
...
const CommandEmpty = ({
  className,
  ...props
}: React.ComponentProps<typeof CommandPrimitive.Empty>) => <CommandPrimitive.Empty
...
const CommandGroup = ({
  className,
  ...props
}: React.ComponentProps<typeof CommandPrimitive.Group>) => <CommandPrimitive.Group
      className={cn(
...
const CommandSeparator = ({
  className,
  ...props
}: React.ComponentProps<typeof CommandPrimitive.Separator>) => <CommandPrimitive.Separator
...
const CommandItem = ({
  ...
  children,
  ...props
}: React.ComponentProps<typeof CommandPrimitive.Item>) => <CommandPrimitive.Item
      className={cn(
...
const CommandShortcut = ({ className, ...props }: React.ComponentProps<'span'>) => <span
      className={cn(
