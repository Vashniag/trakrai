...
const Menubar = ({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.Root>) => <MenubarPrimitive.Root
      className={cn('flex h-8 items-center gap-0.5 rounded-none border p-1', className)}
      data-slot="menubar"
      {...props}
    />;

const MenubarMenu = ({ ...props }: React.ComponentProps<typeof MenubarPrimitive.Menu>) => <MenubarPrimitive.Menu data-slot="menubar-menu" {...props} />;

const MenubarGroup = ({ ...props }: React.ComponentProps<typeof MenubarPrimitive.Group>) => <MenubarPrimitive.Group data-slot="menubar-group" {...props} />;

const MenubarPortal = ({ ...props }: React.ComponentProps<typeof MenubarPrimitive.Portal>) => <MenubarPrimitive.Portal data-slot="menubar-portal" {...props} />;

const MenubarRadioGroup = ({ ...props }: React.ComponentProps<typeof MenubarPrimitive.RadioGroup>) => <MenubarPrimitive.RadioGroup data-slot="menubar-radio-group" {...props} />;

const MenubarTrigger = ({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Trigger>) => <MenubarPrimitive.Trigger
      className={cn(
...
const MenubarContent = ({
  ...
  sideOffset = 8,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Content>) => <MenubarPortal>
...
const MenubarSeparator = ({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Separator>) => <MenubarPrimitive.Separator
      className={cn('bg-border -mx-1 my-1 h-px', className)}
      data-slot="menubar-separator"
      {...props}
    />;

const MenubarShortcut = ({ className, ...props }: React.ComponentProps<'span'>) => <span
      className={cn(
...
const MenubarSub = ({ ...props }: React.ComponentProps<typeof MenubarPrimitive.Sub>) => <MenubarPrimitive.Sub data-slot="menubar-sub" {...props} />;
...
const MenubarSubContent = ({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.SubContent>) => <MenubarPrimitive.SubContent
      className={cn(
