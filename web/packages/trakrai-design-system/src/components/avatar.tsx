...
const AvatarImage = ({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Image>) => <AvatarPrimitive.Image
...
const AvatarBadge = ({ className, ...props }: React.ComponentProps<'span'>) => <span
      className={cn(
...
const AvatarGroup = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
...
const AvatarGroupCount = ({ className, ...props }: React.ComponentProps<'div'>) => <div
      className={cn(
