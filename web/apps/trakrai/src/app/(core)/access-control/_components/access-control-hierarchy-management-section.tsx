...
export const AccessControlHierarchyManagementSection = ({
  ...
  <section className="space-y-5 border p-6">
    <h2 className="text-base font-semibold tracking-tight">Hierarchy management</h2>
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {factories.map((factoryRow) => {
          ...
          return (
            <section key={factoryRow.id} className="space-y-3 border p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <h3 className="text-base font-medium tracking-tight">{factoryRow.name}</h3>
                {isSysadmin ? (
                  <MutationModal
                    defaultValues={{
              ...
              {factoryRow.description !== null && factoryRow.description.trim() !== '' ? (
                <div className="text-muted-foreground text-sm">{factoryRow.description}</div>
              ) : null}
                  ...
                  linkedDepartments.map((departmentRow) => (
                    ...
                    >
                      <div>
                        ...
                        {departmentRow.description !== null &&
                        departmentRow.description.trim() !== '' ? (
