...
def set_logging(name=None, verbose=VERBOSE):
    ...
    # (the trakr-ai logger provides formatted handlers upstream)
    if not log.handlers:
...
def print_args(args: dict | None = None, show_file=True, show_fcn=False):
...
def check_file(file, suffix=""):
    ...
    if file.startswith(("http:/", "https:/")):  # download
        ...
        return file
    if file.startswith("clearml://"):  # ClearML Dataset ID
