    ...
    if service.is_python:
        docker_buildx(
            ...
            build_args={
                ...
                "REQUIREMENTS_FILE": service.build.requirements_file or "requirements.txt",
                "WHEELHOUSE_ABI": service.build.wheelhouse_abi,
                "WHEELHOUSE_IMPLEMENTATION": service.build.wheelhouse_implementation or "cp",
                "WHEELHOUSE_PLATFORM": service.build.wheelhouse_platform,
                "WHEELHOUSE_PYTHON_VERSION": service.build.wheelhouse_python_version,
            },
            context_dir=service.build.context_path,
            platform=platform,
        )
